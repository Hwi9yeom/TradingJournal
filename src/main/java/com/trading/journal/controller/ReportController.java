...
public class ReportController {
    ...
    public ResponseEntity<byte[]> generateYearlyReport(
            @RequestParam(required = false) Long accountId, @RequestParam int year) {
    ...
    @Operation(
            summary = "YTD PDF 리포트 생성",
            description = "올해 1월 1일부터 현재까지의 포트폴리오 성과를 PDF 리포트로 생성합니다")
