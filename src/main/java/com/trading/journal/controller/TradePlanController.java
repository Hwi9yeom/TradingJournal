...
public class TradePlanController {
    ...
    public ResponseEntity<TradePlanDto> updatePlan(
            @PathVariable Long id, @Valid @RequestBody TradePlanDto dto) {
    ...
    public ResponseEntity<TradePlanDto> executePlan(
            @PathVariable Long id, @Valid @RequestBody ExecuteRequest request) {
    ...
    public ResponseEntity<TradePlanDto> updatePlanResult(
        ...
        return ResponseEntity.ok(
                planService.updatePlanResult(id, resultTransactionId, followedPlan));
    }
    ...
    public ResponseEntity<List<TradePlanDto>> getPlansByStatus(
            @PathVariable TradePlanStatus status) {
    ...
    public ResponseEntity<Map<String, Object>> deletePlan(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(Map.of("message", "플랜이 삭제되었습니다", "id", id));
    }
    ...
    public ResponseEntity<PositionSizingResultDto> calculatePositionSize(
        ...
        return ResponseEntity.ok(
                planService.calculatePositionSize(
    ...
    public ResponseEntity<List<Map<String, String>>> getStatuses() {
        List<Map<String, String>> statuses =
                Arrays.stream(TradePlanStatus.values())
                        .map(
                                s ->
                                        Map.of(
                                                "value", s.name(),
    ...
    public ResponseEntity<List<Map<String, String>>> getTypes() {
        List<Map<String, String>> types =
                Arrays.stream(TradePlanType.values())
                        .map(
                                t ->
                                        Map.of(
                                                "value", t.name(),
