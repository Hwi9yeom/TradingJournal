...
public class TradingStatisticsController {
    ...
    public ResponseEntity<TradingStatisticsDto> getFullStatistics(
        ...
        TradingStatisticsDto statistics = tradingStatisticsService.getFullStatistics(accountId, startDate, endDate);
    ...
    public ResponseEntity<List<TimeOfDayStats>> getTimeOfDayPerformance(
        ...
        List<TimeOfDayStats> stats = tradingStatisticsService.getTimeOfDayPerformance(accountId, startDate, endDate);
    ...
    public ResponseEntity<List<WeekdayStats>> getWeekdayPerformance(
        ...
        List<WeekdayStats> stats = tradingStatisticsService.getWeekdayPerformance(accountId, startDate, endDate);
        return ResponseEntity.ok(stats);
    }
    ...
    public ResponseEntity<List<SymbolStats>> getSymbolPerformance(
        ...
        List<SymbolStats> stats = tradingStatisticsService.getSymbolPerformance(accountId, startDate, endDate);
        return ResponseEntity.ok(stats);
    }
    ...
    public ResponseEntity<List<MistakePattern>> getMistakePatterns(
        ...
        List<MistakePattern> patterns = tradingStatisticsService.getMistakePatterns(accountId, startDate, endDate);
    ...
    public ResponseEntity<List<ImprovementSuggestion>> getImprovementSuggestions(
        ...
        List<ImprovementSuggestion> suggestions = tradingStatisticsService.getImprovementSuggestions(accountId, startDate, endDate);
