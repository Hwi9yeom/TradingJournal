...
public class TradingJournalController {
    ...
    public ResponseEntity<List<TradingJournalDto>> getJournalRange(
        ...
        List<TradingJournalDto> journals = journalService.getJournalRange(accountId, startDate, endDate);
    ...
    public ResponseEntity<List<JournalListItem>> getJournalList(
        ...
        List<JournalListItem> journals = journalService.getJournalList(accountId, startDate, endDate);
        return ResponseEntity.ok(journals);
    }
