...
public class AIAssistantController {
    ...
    /**
     * 성과 AI 분석
     * GET /api/ai/analyze/performance?accountId=1&startDate=2025-01-01&endDate=2025-12-31
     */
    ...
    public Mono<ResponseEntity<AIAnalysisResponseDto>> analyzePerformance(
        ...
        return aiService.analyzePerformance(accountId, startDate, endDate)
    ...
    /**
     * 거래 복기 자동 생성
     * POST /api/ai/generate/review/{transactionId}
     */
    ...
    public Mono<ResponseEntity<AIReviewGenerationDto>> generateTradeReview(
        ...
        return aiService.generateTradeReview(transactionId)
                .map(ResponseEntity::ok)
                .onErrorResume(e -> {
    ...
    /**
     * 리스크 경고 분석
     * GET /api/ai/analyze/risk?accountId=1
     */
    ...
    public Mono<ResponseEntity<AIAnalysisResponseDto>> analyzeRiskWarnings(
        ...
        return aiService.analyzeRiskWarnings(accountId)
                .map(ResponseEntity::ok)
                .onErrorResume(e -> {
    ...
    /**
     * 전략 최적화 제안
     * GET /api/ai/suggest/strategy/{backtestId}
     */
    ...
    public Mono<ResponseEntity<AISuggestionDto>> suggestStrategyOptimization(
        ...
        return aiService.suggestStrategyOptimization(backtestId)
                .map(ResponseEntity::ok)
                .onErrorResume(e -> {
                    ...
                    errorResponse.setCurrentStrategyAssessment("전략 분석 중 오류가 발생했습니다: " + e.getMessage());
                    return Mono.just(ResponseEntity.internalServerError().body(errorResponse));
                });
    }
    ...
    public Mono<ResponseEntity<ChatResponse>> chatSync(@RequestBody ChatRequest request) {
        ...
        return aiService.chatSync(sessionId, request.getMessage())
                .map(response -> {
                ...
                .onErrorResume(e -> {
                    ...
                    errorResponse.setMessage("죄송합니다. 응답 생성 중 오류가 발생했습니다: " + e.getMessage());
                    return Mono.just(ResponseEntity.internalServerError().body(errorResponse));
                });
    }
