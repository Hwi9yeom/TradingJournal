    ...
    void updatePortfolio_FirstBuy() {
        ...
        verify(portfolioRepository)
                .save(
                        argThat(
                                portfolio -> {
                                    assertThat(portfolio.getQuantity())
                                            .isEqualByComparingTo(new BigDecimal("10"));
                                    assertThat(portfolio.getTotalInvestment())
                                            .isEqualByComparingTo(new BigDecimal("1505.00"));
                                    assertThat(portfolio.getAveragePrice())
                ...
                .save(
                        argThat(
                                portfolio -> {
                                    ...
                                    assertThat(portfolio.getTotalInvestment())
                                            .isEqualByComparingTo(new BigDecimal("2303.00"));
                                    assertThat(portfolio.getAveragePrice())
                                            .isEqualByComparingTo(new BigDecimal("153.53"));
                                    return true;
                                }));
    }
