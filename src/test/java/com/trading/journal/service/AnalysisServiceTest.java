...
class AnalysisServiceTest {
        ...
        transactions =
                Arrays.asList(
                        ...
                        createTransaction(
                                ...
                                new BigDecimal("10000000")) // realizedPnl, costBasis
                        );
    ...
    void analyzePeriod_ShouldReturnCorrectAnalysis() {
        ...
        assertThat(result.getTotalBuyAmount()).isEqualByComparingTo(new BigDecimal("25000000"));
        assertThat(result.getTotalSellAmount()).isEqualByComparingTo(new BigDecimal("13750000"));
        ...
        // 실현손익 검증 (FIFO 기반)
        assertThat(result.getRealizedProfit()).isEqualByComparingTo(new BigDecimal("1250000"));
    ...
    void analyzePeriod_WithNoTransactions_ShouldReturnEmptyAnalysis() {
        ...
        PortfolioSummaryDto emptyPortfolioSummary =
                PortfolioSummaryDto.builder()
        ...
        when(transactionRepository.findByDateRange(any(), any())).thenReturn(Arrays.asList());
        when(portfolioAnalysisService.getPortfolioSummary()).thenReturn(emptyPortfolioSummary);
    ...
    private Portfolio createPortfolio(
            Stock stock, BigDecimal quantity, BigDecimal averagePrice, BigDecimal totalInvestment) {
